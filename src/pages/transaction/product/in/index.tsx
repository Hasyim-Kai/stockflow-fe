...
import useTransactionInProductVm from './in-product-vm'
import { formatToIdrCurrency } from 'src/utils/helper/currency'

export default function TransactionInProductPage() {
    const vm = useTransactionInProductVm()

    return <CCard className="mb-4">
        <CCardHeader>
            <CRow className='p-2'>
                <CCol xs="auto" >
                    <CCardTitle className="fs-3 fw-semibold">In Product</CCardTitle>
                </CCol>
                                                        ...
                                                        <CCol xs={`11`} className='d-flex flex-column gap-3'>
                                                            ...
                                                            <div className=''>
                                                                <InputField label='Quantity' type="number" name={`productList.${index}.quantity`} placeholder="000"
                                                                    onChange={arrayHelpers.form.handleChange} min={0} />
                                                            </div>
                                                            <div className='mb-3'>
